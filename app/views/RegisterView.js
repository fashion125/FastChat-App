		...
		return (
			<View>
				...
				<TextInput
					...
					placeholder={
						this.props.Accounts_EmailOrUsernamePlaceholder || 'Email'
					}
					returnKeyType='next'
				...
				<TextInput
					...
					label={
						this.props.Accounts_RepeatPasswordPlaceholder || 'Repeat Password'
					}
					placeholder={
						this.props.Accounts_RepeatPasswordPlaceholder || 'Repeat Password'
					}
				...
				<View style={styles.alignItemsFlexStart}>
					...
					<Button title='Register' type='primary' onPress={this.submit} />
				</View>
